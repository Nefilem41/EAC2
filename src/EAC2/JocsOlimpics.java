...
public class JocsOlimpics {
	...
	public static void main(String[] args) {
        ...
        System.out.println("Com que acabem de començar, ara mateix s'han repartit 0 medalles");
        ...
        System.out.println("L'atleta es diu " + a1.nom + " és de " + a1.pais.nom + 
        					" i participa a la competició de " + a1.disciplina);
